...
public class TelaCadastroGUI extends JFrame {
	...
	public TelaCadastroGUI() {
		...
		Object[] column = {"CPF", "Nome", "Logradouro", "Número", "Cidade", "Estado", "Telefone","Tem CNH","N° CNH"};
		...
		btnEnviar.addActionListener(new ActionListener() {
			...
			if(comboBoxEstado.getSelectedItem() == null ||
				...
				JOptionPane.showMessageDialog(null, "Por favor preencha todos os campos");
		  		...
		  		row[7]=textField.getText();
		  		row[8]=textField_1.getText();
		  		modelo.addRow(row);
		...
		btnAlterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				modelo.setValueAt(textField.getText(), i, 7);
				modelo.setValueAt(textField_1.getText(), i, 7);
		...
		btnNewButton.setBounds(551, 221, 89, 30);
		contentPane.add(btnNewButton);
		
		textField = new JTextField();
		textField.setBounds(584, 157, 43, 28);
		contentPane.add(textField);
		textField.setColumns(10);
		
		JLabel lblNewLabel_6_1 = new JLabel("Possui CNH?");
		lblNewLabel_6_1.setBounds(580, 136, 60, 25);
		contentPane.add(lblNewLabel_6_1);
		
		JLabel lblNewLabel_6_1_1 = new JLabel("Numero CNH");
		lblNewLabel_6_1_1.setBounds(692, 136, 90, 25);
		contentPane.add(lblNewLabel_6_1_1);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(669, 162, 100, 25);
